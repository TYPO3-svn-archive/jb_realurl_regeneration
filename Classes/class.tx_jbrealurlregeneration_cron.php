...
class tx_jbrealurlregeneration_cron{
	...
	/**
	 * @param array more cache tables to truncate after the truncat of realurl
	 */
	 ...
	 */
	public function __construct( $TSFE_page_id=0, $tablesToTruncate=''){
	...
	public function execute(){
		...
		$lib->init($content,array(),$this->cObj);				
